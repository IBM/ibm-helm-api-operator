...
The Helm API service requires running with the OpenShift Container Platform 4.3 default privileged Security Context Constraints (SCCs).
...
```
# oc get csv
# oc describe csv ibm-helm-api-operator.v3.6.2
```
